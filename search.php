...
?>
 ...
 <div class="contentsection contemplete clear">
   <div class="maincontent clear">
	<?php
		$query="SELECT * FROM tbl_post WHERE title LIKE '%$sear%' OR body LIKE '%$sear%' " ;// startfrom(where to start) & perpage(total how many pages)
...
<?php } } else { ?>
	<p>Your Search Keyword is not VALID</p>
<?php } ?>		
