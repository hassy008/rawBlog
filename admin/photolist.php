...
<a href="editphoto.php?photoid=<?php echo $result['id'];?>">Edit</a> || <a onclick="return confirm('Do you want to Delete?');" href="delphoto.php?delphoto=<?php echo $result['id'];?>">Delete</a>
