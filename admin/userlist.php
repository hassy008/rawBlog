...
<?php
	if (isset($_GET['deluser'])) {
		...
		$deldata = $db->delete($delquery);	
		    if ($deldata) {
		        echo "<span class='success'><b>User Deleted Successfully</b></span>";
	        }else{
	            echo "<span class='error'><b>User Not Deleted </b></span>";
	        }
	}
?>
...
<?php
        if (Session::get('userRole')=='0') { ?>
				|| <a onclick="return confirm('Do you want to Delete?');" href="?deluser=<?php echo $result['id'];?>">Delete</a>
<?php } ?>
